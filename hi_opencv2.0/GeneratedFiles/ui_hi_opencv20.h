...
public:
    ...
    void setupUi(QMainWindow *hi_opencv20Class)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 411, 415));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 411, 415));
        ...
        QObject::connect(btnTextDetection, SIGNAL(clicked()), hi_opencv20Class, SLOT(on_textDetection()));
    ...
    void retranslateUi(QMainWindow *hi_opencv20Class)
    {
        ...
        toolBox->setItemText(toolBox->indexOf(page_7), QApplication::translate("hi_opencv20Class", "\345\205\266\345\256\203", Q_NULLPTR));
